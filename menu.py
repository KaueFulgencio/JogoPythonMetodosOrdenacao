...
button_largura = tk.Button(canvas, text="Busca em Largura", command=open_busca(busca_largura.busca_largura))
button_largura.place(relx=0.1, rely=0.5)

button_profundidade = tk.Button(canvas, text="Busca em Profundidade", command=open_busca(busca_profundidade.busca_profundidade))
button_profundidade.place(relx=0.3, rely=0.5)

button_gulosa = tk.Button(canvas, text="Busca Gulosa", command=open_busca(busca_gulosa.busca_gulosa))
button_gulosa.place(relx=0.55, rely=0.5)

button_a_estrela = tk.Button(canvas, text="Busca A*", command=open_busca(busca_a.busca_a_estrela))
